...
import FilterDepartmentOffcanvas from "./Forms/FilterDepartmentOffcanvas";
...
export default function Department() {
    ...
    useEffect(() => {
        ...
        const table = window.$('#department-table').DataTable({
                ...
                top2End: {
                    features: [{
                        buttons: [{
                            ...
                            action: function () {
                                $("#filterDepartmentOffcanvas").offcanvas("show");
                            },
                        }, {
                            extend: "collection",
            ...
            ajax: {
                url: route('admin.utilities.departments.data'),
                data: function (d) {
